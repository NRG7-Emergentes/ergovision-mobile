...
final List<Session> sampleSessions = [
  Session(
    ...
    score: 82.5,
    goodScore: 100 * (30 * 60 * 1000.0) / (45 * 60 * 1000.0),
    badScore: 100 * (15 * 60 * 1000.0) / (45 * 60 * 1000.0),
  ...
  Session(
    ...
    score: 76.0,
    goodScore: 100 * (18 * 60 * 1000.0) / (30 * 60 * 1000.0),
    badScore: 100 * (12 * 60 * 1000.0) / (30 * 60 * 1000.0),
  ...
  Session(
    ...
    score: 90.0,
    goodScore: 100 * (50 * 60 * 1000.0) / (60 * 60 * 1000.0),
    badScore: 100 * (10 * 60 * 1000.0) / (60 * 60 * 1000.0),
  ...
  Session(
    ...
    score: 68.0,
    goodScore: 100 * (10 * 60 * 1000.0) / (25 * 60 * 1000.0),
    badScore: 100 * (15 * 60 * 1000.0) / (25 * 60 * 1000.0),
  ...
  Session(
    ...
    score: 20.0,
    goodScore: 100 * (12 * 60 * 1000.0) / (20 * 60 * 1000.0),
    badScore: 100 * (8 * 60 * 1000.0) / (20 * 60 * 1000.0),
